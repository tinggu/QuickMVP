 ...
 */
package com.cyou.quick.mvp.viewstate.layout;
...
import com.cyou.quick.mvp.delegate.MvpViewStateViewGroupDelegateCallback;
import com.cyou.quick.mvp.delegate.ViewGroupMvpDelegate;
import com.cyou.quick.mvp.delegate.ViewGroupMvpViewStateDelegateImpl;
import com.cyou.quick.mvp.layout.MvpRelativeLayout;
import com.cyou.quick.mvp.viewstate.RestoreableParcelableViewState;
...
public abstract class MvpViewStateRelativeLayout<V extends MvpView, P extends MvpPresenter<V>>
  ...
  @Override
  public RestoreableParcelableViewState getViewState() {
    return viewState;
  }
