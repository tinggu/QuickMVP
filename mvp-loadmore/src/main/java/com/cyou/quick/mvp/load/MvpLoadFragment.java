 ...
 * @since 1.0.0
 */
public abstract class MvpLoadFragment<CV extends View, M, V extends MvpLoadView<M>, P extends MvpPresenter<V>>
        extends MvpFragment<V, P> implements MvpLoadView<M> {
